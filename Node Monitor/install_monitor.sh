...
echo "Скачиваем основной скрипт монитора с ${MONITOR_SCRIPT_URL}..."
...
echo "1. Откройте скачанный скрипт: nano ${MONITOR_INSTALL_DIR}/${MONITOR_SCRIPT_NAME}"
echo "2. Измените в нем следующие переменные вручную:"
...
echo "   - BASE_USER_HOME (абсолютный путь к домашнему каталогу пользователя, где лежат бинарники нод и .home директории, например, /home/Your_User_Name)"
echo "     В данном случае, если вы запускаете скрипт от пользователя 'bestvalidator', то значением будет /home/bestvalidator."
echo "3. Добавьте конфигурации для ваших сетей в ассоциативный массив NETWORKS."
echo "4. Добавьте задание в cron для пользователя, от которого хотите запускать монитор (обычно это ваш текущий пользователь):"
echo "   crontab -e"
