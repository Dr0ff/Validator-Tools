...
echo -e "\n  1. Откройте скачанный скрипт: \e[93mnano ${MONITOR_INSTALL_DIR}/${MONITOR_SCRIPT_NAME}\e[0m"
...
echo -e "     - BASE_USER_HOME (абсолютный путь к домашнему каталогу пользователя, где лежат бинарники нод\n       и .home директории, например, /home/Your_User_Name)"
...
echo -e "\n  4. Добавьте задание в cron для пользователя, от которого хотите запускать монитор\n     (обычно это ваш текущий пользователь):"
echo -e "\e[93m     crontab -e\e[0m\n"
echo "     Добавьте строку (например, для запуска каждые 10 минут):"
echo -e "\e\n[93m     */10 * * * * ${MONITOR_INSTALL_DIR}/${MONITOR_SCRIPT_NAME}\e[0m"
echo ""
echo "  Для тестирования вручную: ${MONITOR_INSTALL_DIR}/${MONITOR_SCRIPT_NAME} --debug"

echo -e "\n\e[93m  Обратите внимание на краткую инструкцию приведённую выше!\n\e[0m"
